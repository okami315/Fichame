 ...
 */
final class Version20230621083337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration CHANGE checkin checkin DATETIME DEFAULT NULL, CHANGE checkout checkout DATETIME DEFAULT NULL, CHANGE createcheckin createcheckin DATETIME DEFAULT NULL, CHANGE createcheckout createcheckout DATETIME DEFAULT NULL');
